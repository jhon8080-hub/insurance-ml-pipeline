"""
Тестирование дерева решений (src/DT_test.py)
"""
...
with open('metrics/DT_metrics.json') as f:
...
with open('metrics/DT_test_metrics.json', 'w', encoding='utf-8') as f:
    json.dump(metrics, f, indent=2, ensure_ascii=False)

print(f"\nМетрики сохранены: metrics/DT_test_metrics.json")
